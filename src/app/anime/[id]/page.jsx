            ...
            <footer className="bg-color-hitam mx-8 pt-80 text-[7px] md:text-[11px] sm:text-[11px] lg:text-[11px] ">
                <div className="text-color-primary">
                    ...
                    <section className="bg-color-hitam flex flex-cols-10 items-center gap-1 pt-4 mr-20">
                        ...
                        <div className="bg-color-secondary px-2 mr-10 py-1 hover:bg-color-dark transition-all rounded-sm">
                            <h3 className="text-color-primary"></h3>
                            <a href="https://www.linkedin.com/in/alvin-zanua-putra-34a758288/">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" viewBox="0 0 256 256"><path d="M216,24H40A16,16,0,0,0,24,40V216a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V40A16,16,0,0,0,216,24Zm0,192H40V40H216V216ZM96,112v64a8,8,0,0,1-16,0V112a8,8,0,0,1,16,0Zm88,28v36a8,8,0,0,1-16,0V140a20,20,0,0,0-40,0v36a8,8,0,0,1-16,0V112a8,8,0,0,1,15.79-1.78A36,36,0,0,1,184,140ZM100,84A12,12,0,1,1,88,72,12,12,0,0,1,100,84Z"></path></svg>
                            </a>
                        </div>
                    </section>
