...
const AnimeList = ({ api }) => {
    ...
    return (
        <div className="grid grid-cols-2 pb-10 mt-4 gap-6 mx-4 md:grid-cols-5 xs:grid-cols-4 lg:grid-cols-6 animate__animated animate__fadeInLeft animate__delay-1s">
