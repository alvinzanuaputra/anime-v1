...
const UserActionButton = async() => {
    ...
    return (
        <div className="flex items-center justify-between gap-2 animate__animated animate__bounce animate__delay-4s">
            {
                user ? <Link href="/users/dashboard" className ="inline-block bg-color-dark text-color-primary rounded-lg border border-color-accent py-1 px-8 lg:font-bold
